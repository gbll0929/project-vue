...
var storage = multer.diskStorage({
  destination: function (req, file, cb) {
    ...
    }else if(req.url.indexOf('doctors')!==-1){
		cb(null, path.join(__dirname, 'public','upload','doctors'))
	}else if(req.url.indexOf('news')!==-1){
...
app.use('/api/getcomments', require('./routes/api/getcomments'));
